...
load(file=paste0("~/RSVcorrelatesAnalysis/Result/outCohort_",ps,"_",y.v,".Rdata"))
...
dat.wide.ppim.boot<-dat.wide.ppim[c(oo.0.boot,oo.1.boot),]
...
out.VE1,out.VE2,out.VE3,out.VE4,out.ll,file=paste0("~/RSVcorrelatesAnalysis/Result/outbootCohort_",ps,"_",y.v,"_",index3,".Rdata"))
