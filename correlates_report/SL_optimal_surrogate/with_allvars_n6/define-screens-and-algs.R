...
## screen based on logistic regression univariate p-value < level (0.10)
...
## There 28 combinations for learners and screens
## -------------------------------------------------------------------------------------
