...
# For placebo, y2 endpoint
data_folder <- "N:/cavd/Objective 4/GH-VAP/ID33-Wilson/Data/adata/objective3/results_with_allvars_n6/y2_placebo/"
y2_placebo <- readin_SLobjects_fromFolder(data_folder, file_pattern = "*.rds", endpoint = "y2", trt = "placebo") %>%
...
save(y2_placebo, file = paste0(data_folder, "y2_placebo.rda"))
